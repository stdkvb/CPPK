const takeControlMenu = () => {
	...
	const programmsListRequestBtn = document.getElementById('programms-list-request-btn')
	const programmsListRequestMenu = document.getElementById('programms-list-request-menu')
	...
	function closeAllMenu() {
		...
		programmsListRequestMenu.classList.remove('service-menu_active')
	...
	if (programmsListRequestBtn !== null) {
		programmsListRequestBtn.addEventListener('click', () => {
			closeAllMenu()
			programmsListRequestMenu.classList.add('service-menu_active')
		})
	}
